...
# Евстягин Никита и Лазарев Валерий 11-208
...
## Task 3
 ...
 2) Реализовать булев поиск по построенному индексу
    ### Замечание:
      1. в рамках выполнения задания должны быть реализованы
         1. операторы AND, OR, NOT
         2. возможность вводить сложный запрос
...
## Task 5
 ...
 2) Добавить поисковую систему на основе векторного поиска по построенному индексу:
    1. WEB интерфейс
    2. ранжирование
    3. вывод топ 10 результатов по введенному запросу
